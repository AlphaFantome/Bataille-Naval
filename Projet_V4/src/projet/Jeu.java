   ...
   /* public void plateauEvolutifJoueur(char ligne, int colonne)
    ...
    public int Selectionner()
    {
        ...
        while(!"CU".equals(nom))
        {
            ...
            nom=scanner.next();
            System.out.println("Valeur nom : "+nom+"|");
        }
    ...
    public void choixAction()
    {
            ...
            switch(choix)
        {
            case 1 :
                System.out.println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
                  test=tabBateauJoueur[numeroBateau].deplacer(plateauJoueur);
                  if(test==false)
                  {
            ...
            case 2 :
                System.out.println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
                tabBateauJoueur[numeroBateau].tirer(plateauAttaque, tabBateauAI);
                affichageJoueurGrille();
                affichageAttaqueGrille();
