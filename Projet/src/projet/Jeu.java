...
public class Jeu {
    ...
    public void initialisationgrilleJoueur()
    {
        ...
        tabBateauJoueur[0] = new Cuirassé(plateauJoueur, "C");
    ...
    public void initialisationgrilleAttaque()
    {
        ...
        tabBateauAI[0] = new Cuirassé(plateauAttaque, "C");
    ...
    public void affichageJoueurGrille()
    {
        int ascii=65;
         ...
         for(int i=0;i<16;i++)
         {
             ...
             for(int j = 0; j<16;j++)
             {
                 System.out.println( " | "+plateauJoueur[i][j]+" | ");
             }     
         }
         System.out.println("-------------------------------------------------------------");
    }
    ...
    public void affichageAttaqueGrille()
    {
         ...
         for(int i=0;i<16;i++)
         {
             ...
             {
                 System.out.print( "|");
                 if(("TTT".equals(plateauAttaque[i][j]))||("XXX".equals(plateauAttaque[i][j])))
                 {
    ...
    public void Selectionner()
    {
        ...
        if(tabBateauJoueur[i].vivant==false)
        {
